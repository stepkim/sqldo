...
func MessagePush(workid string, t uint, reject string) {
	...
	if model.GloOther.Query && t > 6 {
		...
		if t == 7 {
			...
			mail = fmt.Sprintf(TmplMail, "查询申请", op.WorkId, op.Username, model.Host, model.Host, "收到工单提醒，请及时登录SQLDo平台查看")
		}
		if t == 8 {
		...
		case 1:
			...
			mail = fmt.Sprintf(TmplMail, "执行", o.WorkId, o.Username, model.Host, model.Host, "您提交的工单已执行成功，请及时确认结果")
		case 2:
			...
			mail = fmt.Sprintf(TmplMail, "提交", o.WorkId, o.Username, model.Host, model.Host, "您有工单待审核，请及时登录SQLDo平台查看")
		case 4:
			ding = fmt.Sprintf(TmplFailedDing, o.WorkId, o.Source, o.Username, o.Assigned, model.Host, o.Text)
			mail = fmt.Sprintf(TmplMail, "执行", o.WorkId, o.Username, model.Host, model.Host, "您提交的工单已执行失败，请及时相关人员")
		case 5:
			model.DB().Select("email").Where("username =?", o.Assigned).First(&user)
			s.ToUser = user.Email
			ding = fmt.Sprintf(TmplPerformDing, o.WorkId, o.Source, o.Username, o.Assigned, model.Host, o.Text)
			mail = fmt.Sprintf(Tmpl2Mail, "转交", o.WorkId, o.Username, o.Assigned, model.Host, model.Host, "您参与的工单已转交至下一操作人，请及时通知下一个操作人")
		case 6:
			ding = fmt.Sprintf(TmplBackDing, o.WorkId, o.Source, o.Username, o.Assigned, model.Host, o.Text)
			mail = fmt.Sprintf(TmplMail, "撤销", o.WorkId, o.Username, model.Host, model.Host, "您提交的工单被撤销")
		}
	}
